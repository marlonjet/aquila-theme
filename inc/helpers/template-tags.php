...
function aquila_posted_on()
{
    ...
    // Post is modified ( when post published time is not equal to post time modified )
...
function aquila_posted_by()
{
    $byline = sprintf(
        ...
        '<span class="author vcard"><a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" rel="bookmark">' . get_the_author() . '</a></span>'
    );
